...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['NFTTokenResponse']:
            return NFTTokenResponse

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['NFTTokenResponse'], typing.List['NFTTokenResponse']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'NFTTokenResponse':
        return super().__getitem__(i)
...
class GetNftsByIds(BaseApi):
    ...
    def get_nfts_by_ids(
        ...
        return self._get_nfts_by_ids_oapg(
