...
SchemaFor200ResponseBodyApplicationJson = NFTOwnersByTokensResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_nft_owners_by_tokens_oapg(
        self,
...
class GetNftOwnersByTokens(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_nft_owners_by_tokens(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_nft_owners_by_tokens(
        ...
        return self._get_nft_owners_by_tokens_oapg(
