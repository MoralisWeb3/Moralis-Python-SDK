...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['GetAccountModuleResponse']:
            return GetAccountModuleResponse

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['GetAccountModuleResponse'], typing.List['GetAccountModuleResponse']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'GetAccountModuleResponse':
...
class GetAccountModules(BaseApi):
    ...
    def get_account_modules(
        ...
        return self._get_account_modules_oapg(
