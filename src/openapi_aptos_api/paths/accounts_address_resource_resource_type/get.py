...
request_path_resource_type = api_client.PathParameter(
    name="resource_type",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ResourceTypeSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = GetAccountResourceResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_account_resource_oapg(
        self,
...
class GetAccountResource(BaseApi):
    ...
    def get_account_resource(
        ...
        return self._get_account_resource_oapg(
