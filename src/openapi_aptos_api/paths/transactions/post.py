...
SchemaFor200ResponseBodyApplicationJson = PendingTransaction
...
class SubmitTransaction(BaseApi):
    ...
    def submit_transaction(
        ...
        return self._submit_transaction_oapg(
            body=body,
