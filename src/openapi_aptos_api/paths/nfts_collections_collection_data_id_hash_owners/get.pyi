...
SchemaFor200ResponseBodyApplicationJson = NFTOwnersByCollectionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_nft_owners_by_collection_oapg(
        self,
...
class GetNftOwnersByCollection(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_nft_owners_by_collection(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_nft_owners_by_collection(
        ...
        return self._get_nft_owners_by_collection_oapg(
