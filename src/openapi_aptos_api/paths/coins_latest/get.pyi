...
SchemaFor200ResponseBodyApplicationJson = GetLatestCoinsResponse
...
class GetLatestCoins(BaseApi):
    ...
    def get_latest_coins(
        ...
        return self._get_latest_coins_oapg(
