...
# Path params
TxnHashSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'txn_hash': typing.Union[TxnHashSchema, str, ],
    }
)
...
request_path_txn_hash = api_client.PathParameter(
    name="txn_hash",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_transaction_by_hash_oapg(
        self,
...
class GetTransactionByHash(BaseApi):
    ...
    def get_transaction_by_hash(
        ...
        return self._get_transaction_by_hash_oapg(
