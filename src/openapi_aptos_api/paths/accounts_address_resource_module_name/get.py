...
ModuleNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'address': typing.Union[AddressSchema, str, ],
        'module_name': typing.Union[ModuleNameSchema, str, ],
    }
)
...
request_path_module_name = api_client.PathParameter(
    name="module_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ModuleNameSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = GetAccountModuleResponse
...
class GetAccountModule(BaseApi):
    ...
    def get_account_module(
        ...
        return self._get_account_module_oapg(
