...
# Path params
TxnVersionSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'txn_version': typing.Union[TxnVersionSchema, str, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_transaction_by_version_oapg(
        self,
...
class GetTransactionByVersion(BaseApi):
    ...
    def get_transaction_by_version(
        ...
        return self._get_transaction_by_version_oapg(
