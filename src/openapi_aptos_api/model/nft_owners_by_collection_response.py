...
class NFTOwnersByCollectionResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NFTOwnerResponse']:
                        return NFTOwnerResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NFTOwnerResponse'], typing.List['NFTOwnerResponse']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'result':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'NFTOwnerResponse':
