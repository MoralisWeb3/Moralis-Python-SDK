...
class GetCoinBalancesByWalletsResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CurrentCoinBalanceDto']:
                        return CurrentCoinBalanceDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CurrentCoinBalanceDto'], typing.List['CurrentCoinBalanceDto']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'result':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CurrentCoinBalanceDto':
