...
class GetNFTTransfersByCollectionResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NFTTransferResponse']:
                        return NFTTransferResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NFTTransferResponse'], typing.List['NFTTransferResponse']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'result':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'NFTTransferResponse':
