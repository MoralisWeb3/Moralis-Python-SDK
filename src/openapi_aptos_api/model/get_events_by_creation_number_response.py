...
class GetEventsByCreationNumberResponse(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "guid", "sequence_number", "type", "data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "guid", "sequence_number", "type", "data", ], str]):
