...
class GetHistoricalCoinBalancesByWalletsResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['HistoricalCoinBalanceDto']:
                        return HistoricalCoinBalanceDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['HistoricalCoinBalanceDto'], typing.List['HistoricalCoinBalanceDto']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'result':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'HistoricalCoinBalanceDto':
