...
from openapi_streams.paths.streams_aptos_id.delete import RequestPathParams
...
def aptos_streams_delete(api_key: str, params: Params):
    ...
    api_response = api_instance.aptos_streams_delete(
