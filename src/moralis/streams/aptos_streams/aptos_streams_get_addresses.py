...
from openapi_streams.paths.streams_aptos_id_address.get import RequestQueryParams, RequestPathParams
...
def aptos_streams_get_addresses(api_key: str, params: Params):
    ...
    api_response = api_instance.aptos_streams_get_addresses(
