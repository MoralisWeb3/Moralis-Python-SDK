...
from openapi_aptos_api.paths.coins_names.get import RequestQueryParams
...
def get_coins_by_name_range(api_key: str, params: Params):
    ...
    api_response = api_instance.get_coins_by_name_range(
