...
from openapi_aptos_api.paths.coins_latest.get import RequestQueryParams
...
def get_latest_coins(api_key: str, params: Params):
    ...
    api_response = api_instance.get_latest_coins(
