...
from openapi_aptos_api.paths.coins.get import RequestQueryParams
...
def get_coin_info_by_coin_type_hashes(api_key: str, params: Params):
    ...
    api_response = api_instance.get_coin_info_by_coin_type_hashes(
