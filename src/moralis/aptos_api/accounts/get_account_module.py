...
from openapi_aptos_api.paths.accounts_address_resource_module_name.get import RequestQueryParams, RequestPathParams
...
def get_account_module(api_key: str, params: Params):
