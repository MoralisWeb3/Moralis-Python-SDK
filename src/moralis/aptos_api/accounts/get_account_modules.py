...
from openapi_aptos_api.paths.accounts_address_modules.get import RequestQueryParams, RequestPathParams
...
def get_account_modules(api_key: str, params: Params):
