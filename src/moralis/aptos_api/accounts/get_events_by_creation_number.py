...
from openapi_aptos_api.paths.accounts_address_events_creation_number.get import RequestQueryParams, RequestPathParams
...
def get_events_by_creation_number(api_key: str, params: Params):
    ...
    api_response = api_instance.get_events_by_creation_number(
