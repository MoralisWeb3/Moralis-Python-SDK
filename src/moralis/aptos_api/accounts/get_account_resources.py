...
from openapi_aptos_api.paths.accounts_address_resources.get import RequestQueryParams, RequestPathParams
...
def get_account_resources(api_key: str, params: Params):
