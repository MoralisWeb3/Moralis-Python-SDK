...
from openapi_aptos_api.paths.collections_creators.get import RequestQueryParams
...
def get_nft_collections_by_creator(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_collections_by_creator(
