...
from openapi_aptos_api.paths.collections_ids.get import RequestQueryParams
...
def get_nft_collections_by_ids(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_collections_by_ids(
