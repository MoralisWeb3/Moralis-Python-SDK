...
from openapi_aptos_api.paths.collections.get import RequestQueryParams
...
def get_nft_collections(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_collections(
