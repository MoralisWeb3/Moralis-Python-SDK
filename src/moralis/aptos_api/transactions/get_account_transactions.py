...
from openapi_aptos_api.paths.accounts_address_transactions.get import RequestQueryParams, RequestPathParams
...
def get_account_transactions(api_key: str, params: Params):
