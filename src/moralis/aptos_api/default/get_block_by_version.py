...
from openapi_aptos_api.paths.blocks_by_version_version.get import RequestQueryParams, RequestPathParams
...
def get_block_by_version(api_key: str, params: Params):
    ...
    api_response = api_instance.get_block_by_version(
