...
from openapi_aptos_api.paths.wallets_coins_history.get import RequestQueryParams
...
def get_historical_coin_balances_by_wallets(api_key: str, params: Params):
    ...
    api_response = api_instance.get_historical_coin_balances_by_wallets(
