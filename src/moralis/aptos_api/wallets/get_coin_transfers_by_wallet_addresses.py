...
from openapi_aptos_api.paths.wallets_coins_transfers.get import RequestQueryParams
...
def get_coin_transfers_by_wallet_addresses(api_key: str, params: Params):
    ...
    api_response = api_instance.get_coin_transfers_by_wallet_addresses(
