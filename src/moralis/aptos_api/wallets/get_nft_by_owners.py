...
from openapi_aptos_api.paths.wallets_nfts.get import RequestQueryParams
...
def get_nft_by_owners(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_by_owners(
