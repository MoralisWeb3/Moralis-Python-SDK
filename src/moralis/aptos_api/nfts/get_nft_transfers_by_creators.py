...
from openapi_aptos_api.paths.nfts_transfers_creators.get import RequestQueryParams
...
def get_nft_transfers_by_creators(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_transfers_by_creators(
