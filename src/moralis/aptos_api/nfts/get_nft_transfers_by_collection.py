...
from openapi_aptos_api.paths.nfts_transfers_collections_collection_data_id_hash.get import RequestQueryParams, RequestPathParams
...
def get_nft_transfers_by_collection(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_transfers_by_collection(
