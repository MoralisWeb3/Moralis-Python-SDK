...
from openapi_aptos_api.paths.nfts_transfers_wallets.get import RequestQueryParams
...
def get_nft_transfers_by_wallets(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_transfers_by_wallets(
