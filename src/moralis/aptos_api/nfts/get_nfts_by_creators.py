...
from openapi_aptos_api.paths.nfts_creators.get import RequestQueryParams
...
def get_nfts_by_creators(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nfts_by_creators(
