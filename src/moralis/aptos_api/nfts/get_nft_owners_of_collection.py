...
from openapi_aptos_api.paths.nfts_collections_collection_data_id_hash_owners_list.get import RequestQueryParams, RequestPathParams
...
def get_nft_owners_of_collection(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_owners_of_collection(
