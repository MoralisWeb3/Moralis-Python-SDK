...
import typing
from openapi_evm_api.paths.address_nft.get import RequestQueryParams, RequestPathParams


def get_wallet_nfts(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
