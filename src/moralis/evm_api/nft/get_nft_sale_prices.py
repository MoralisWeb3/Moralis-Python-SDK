...
from openapi_evm_api.paths.nft_address_token_id_price.get import RequestQueryParams, RequestPathParams
...
def get_nft_sale_prices(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_sale_prices(
