...
import typing
from openapi_evm_api.paths.nft_address_lowestprice.get import RequestQueryParams, RequestPathParams


def get_nft_lowest_price(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
