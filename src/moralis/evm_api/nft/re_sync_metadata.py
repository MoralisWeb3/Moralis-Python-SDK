...
import typing
from openapi_evm_api.paths.nft_address_token_id_metadata_resync.get import RequestQueryParams, RequestPathParams


def re_sync_metadata(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
