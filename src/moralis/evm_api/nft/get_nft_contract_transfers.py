...
from openapi_evm_api.paths.nft_address_transfers.get import RequestQueryParams, RequestPathParams
...
def get_nft_contract_transfers(api_key: str, params: Params):
