...
import typing
from openapi_evm_api.paths.block_block_number_or_hash_nft_transfers.get import RequestQueryParams, RequestPathParams


def get_nft_transfers_by_block(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
