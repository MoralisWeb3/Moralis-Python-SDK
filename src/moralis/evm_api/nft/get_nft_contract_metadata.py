...
import typing
from openapi_evm_api.paths.nft_address_metadata.get import RequestQueryParams, RequestPathParams


def get_nft_contract_metadata(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
