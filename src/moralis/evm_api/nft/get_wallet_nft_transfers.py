...
import typing
from openapi_evm_api.paths.address_nft_transfers.get import RequestQueryParams, RequestPathParams


def get_wallet_nft_transfers(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
