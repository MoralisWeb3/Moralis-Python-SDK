...
import typing
from openapi_evm_api.paths.nft_address_owners.get import RequestQueryParams, RequestPathParams


def get_nft_owners(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
