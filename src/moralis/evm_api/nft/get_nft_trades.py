...
import typing
from openapi_evm_api.paths.nft_address_trades.get import RequestQueryParams, RequestPathParams


def get_nft_trades(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
