...
import typing
from openapi_evm_api.paths.nft_address_token_id.get import RequestQueryParams, RequestPathParams


def get_nft_metadata(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
