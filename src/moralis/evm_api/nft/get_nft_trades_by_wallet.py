...
from openapi_evm_api.paths.wallets_address_nfts_trades.get import RequestQueryParams, RequestPathParams
...
def get_nft_trades_by_wallet(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_trades_by_wallet(
