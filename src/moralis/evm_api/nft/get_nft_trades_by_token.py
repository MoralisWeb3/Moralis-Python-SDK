...
from openapi_evm_api.paths.nft_address_token_id_trades.get import RequestQueryParams, RequestPathParams
...
def get_nft_trades_by_token(api_key: str, params: Params):
    ...
    api_response = api_instance.get_nft_trades_by_token(
