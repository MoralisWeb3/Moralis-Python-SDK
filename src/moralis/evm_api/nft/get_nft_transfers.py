...
import typing
from openapi_evm_api.paths.nft_address_token_id_transfers.get import RequestQueryParams, RequestPathParams


def get_nft_transfers(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
