...
import typing
from openapi_evm_api.paths.block_block_number_or_hash.get import RequestQueryParams, RequestPathParams


def get_block(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
