...
from openapi_evm_api.paths.block_block_number_or_hash_stats.get import RequestQueryParams, RequestPathParams
...
def get_block_stats(api_key: str, params: Params):
    ...
    api_response = api_instance.get_block_stats(
