...
from openapi_evm_api.paths.wallets_address_profitability_summary.get import RequestQueryParams, RequestPathParams
...
def get_wallet_profitability_summary(api_key: str, params: Params):
    ...
    api_response = api_instance.get_wallet_profitability_summary(
