...
from openapi_evm_api.paths.wallets_address_history.get import RequestQueryParams, RequestPathParams
...
def get_wallet_history(api_key: str, params: Params):
    ...
    api_response = api_instance.get_wallet_history(
