...
from openapi_evm_api.paths.wallets_address_net_worth.get import RequestQueryParams, RequestPathParams
...
def get_wallet_net_worth(api_key: str, params: Params):
    ...
    api_response = api_instance.get_wallet_net_worth(
