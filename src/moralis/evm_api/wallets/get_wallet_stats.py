...
from openapi_evm_api.paths.wallets_address_stats.get import RequestQueryParams, RequestPathParams
...
def get_wallet_stats(api_key: str, params: Params):
    ...
    api_response = api_instance.get_wallet_stats(
