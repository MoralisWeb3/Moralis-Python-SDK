...
from openapi_evm_api.paths.wallets_address_defi_positions.get import RequestQueryParams, RequestPathParams
...
def get_defi_positions_summary(api_key: str, params: Params):
    ...
    api_response = api_instance.get_defi_positions_summary(
