...
from openapi_evm_api.paths.wallets_address_tokens.get import RequestQueryParams, RequestPathParams
...
def get_wallet_token_balances_price(api_key: str, params: Params):
    ...
    api_response = api_instance.get_wallet_token_balances_price(
