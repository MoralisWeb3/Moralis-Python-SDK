...
from openapi_evm_api.paths.transaction_transaction_hash_verbose.get import RequestQueryParams, RequestPathParams
...
def get_transaction_verbose(api_key: str, params: Params):
    ...
    api_response = api_instance.get_transaction_verbose(
