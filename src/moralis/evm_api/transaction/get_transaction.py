...
import typing
from openapi_evm_api.paths.transaction_transaction_hash.get import RequestQueryParams, RequestPathParams


def get_transaction(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
