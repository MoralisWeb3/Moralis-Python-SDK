...
import typing
from openapi_evm_api.paths.address.get import RequestQueryParams, RequestPathParams


def get_wallet_transactions(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
