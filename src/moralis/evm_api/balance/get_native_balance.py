...
import typing
from openapi_evm_api.paths.address_balance.get import RequestQueryParams, RequestPathParams


def get_native_balance(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
