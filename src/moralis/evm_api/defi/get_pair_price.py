...
from openapi_evm_api.paths.token0_address_token1_address_price.get import RequestQueryParams, RequestPathParams
...
def get_pair_price(api_key: str, params: Params):
    ...
    api_response = api_instance.get_pair_price(
