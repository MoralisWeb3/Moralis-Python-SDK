...
import typing
from openapi_evm_api.paths.pair_address_reserves.get import RequestQueryParams, RequestPathParams


def get_pair_reserves(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
