...
import typing
from openapi_evm_api.paths.address_logs.get import RequestQueryParams, RequestPathParams


def get_contract_logs(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
