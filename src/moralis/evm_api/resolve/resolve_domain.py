...
import typing
from openapi_evm_api.paths.resolve_domain.get import RequestQueryParams, RequestPathParams

def resolve_domain(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
