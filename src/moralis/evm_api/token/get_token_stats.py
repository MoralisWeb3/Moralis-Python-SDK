...
from openapi_evm_api.paths.erc20_address_stats.get import RequestQueryParams, RequestPathParams
...
def get_token_stats(api_key: str, params: Params):
    ...
    api_response = api_instance.get_token_stats(
