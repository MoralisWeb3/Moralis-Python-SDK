...
from openapi_evm_api.paths.erc20_mints.get import RequestQueryParams
...
def get_erc20_mints(api_key: str, params: Params):
    ...
    api_response = api_instance.get_erc20_mints(
