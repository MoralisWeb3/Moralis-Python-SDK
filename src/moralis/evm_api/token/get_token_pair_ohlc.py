...
from openapi_evm_api.paths.token0_token1_ohlc.get import RequestQueryParams, RequestPathParams
...
def get_token_pair_ohlc(api_key: str, params: Params):
    ...
    api_response = api_instance.get_token_pair_ohlc(
