...
import typing
from openapi_evm_api.paths.erc20_address_transfers.get import RequestQueryParams, RequestPathParams


def get_token_transfers(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
