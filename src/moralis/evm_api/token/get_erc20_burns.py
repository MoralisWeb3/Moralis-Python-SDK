...
from openapi_evm_api.paths.erc20_burns.get import RequestQueryParams
...
def get_erc20_burns(api_key: str, params: Params):
    ...
    api_response = api_instance.get_erc20_burns(
