...
import typing
from openapi_evm_api.paths.address_erc20_transfers.get import RequestQueryParams, RequestPathParams


def get_wallet_token_transfers(api_key: str, params: typing.Union[RequestQueryParams, RequestPathParams]):
