...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Erc20TokenBalance']:
    ...
    def __getitem__(self, i: int) -> 'Erc20TokenBalance':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wallet_token_balances_oapg(
        self,
...
class GetWalletTokenBalances(BaseApi):
