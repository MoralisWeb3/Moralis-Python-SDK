...
OneMonthLiquidityChangeUsdSchema = schemas.NumberSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'one_month_liquidity_change_usd': typing.Union[OneMonthLiquidityChangeUsdSchema, decimal.Decimal, int, float, ],
...
request_query_one_month_liquidity_change_usd = api_client.QueryParameter(
    name="one_month_liquidity_change_usd",
    style=api_client.ParameterStyle.FORM,
    schema=OneMonthLiquidityChangeUsdSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_rising_liquidity_tokens_oapg(
        self,
    ...
    def _get_rising_liquidity_tokens_oapg(
        ...
        for parameter in (
            request_query_chain,
            request_query_one_month_liquidity_change_usd,
...
class GetRisingLiquidityTokens(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_rising_liquidity_tokens(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_rising_liquidity_tokens(
        ...
        return self._get_rising_liquidity_tokens_oapg(
