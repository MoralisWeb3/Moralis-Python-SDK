...
request_query_one_week_experienced_net_buyers_change = api_client.QueryParameter(
    name="one_week_experienced_net_buyers_change",
    style=api_client.ParameterStyle.FORM,
    schema=OneWeekExperiencedNetBuyersChangeSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_experienced_buyers_tokens_oapg(
        self,
...
class GetExperiencedBuyersTokens(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_experienced_buyers_tokens(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_experienced_buyers_tokens(
        ...
        return self._get_experienced_buyers_tokens_oapg(
