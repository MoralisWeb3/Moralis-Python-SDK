...
SchemaFor200ResponseBodyApplicationJson = WalletTopProfitableWalletPerTokenResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_top_profitable_wallet_per_token_oapg(
        self,
...
class GetTopProfitableWalletPerToken(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_top_profitable_wallet_per_token(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_top_profitable_wallet_per_token(
        ...
        return self._get_top_profitable_wallet_per_token_oapg(
