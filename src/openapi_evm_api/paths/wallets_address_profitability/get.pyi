...
SchemaFor200ResponseBodyApplicationJson = WalletProfitabilityResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wallet_profitability_oapg(
        self,
...
class GetWalletProfitability(BaseApi):
    ...
    def get_wallet_profitability(
        ...
        return self._get_wallet_profitability_oapg(
