...
SchemaFor200ResponseBodyApplicationJson = MarketDataTopNFTCollectionByMarketCap
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_top_nft_collections_by_market_cap_oapg(
        self,
...
class GetTopNftCollectionsByMarketCap(BaseApi):
    ...
    def get_top_nft_collections_by_market_cap(
        ...
        return self._get_top_nft_collections_by_market_cap_oapg(
