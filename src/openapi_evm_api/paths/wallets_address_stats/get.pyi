...
SchemaFor200ResponseBodyApplicationJson = WalletStat
...
class GetWalletStats(BaseApi):
    ...
    def get_wallet_stats(
        ...
        return self._get_wallet_stats_oapg(
