...
SchemaFor200ResponseBodyApplicationJson = UnstoppableDomain
...
class BaseApi(api_client.Api):
    @typing.overload
    def _resolve_address_to_domain_oapg(
        self,
...
class ResolveAddressToDomain(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def resolve_address_to_domain(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def resolve_address_to_domain(
        ...
        return self._resolve_address_to_domain_oapg(
