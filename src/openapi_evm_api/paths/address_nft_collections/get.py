...
SchemaFor200ResponseBodyApplicationJson = NftWalletCollections
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wallet_nft_collections_oapg(
        self,
...
class GetWalletNftCollections(BaseApi):
    ...
    def get_wallet_nft_collections(
        ...
        return self._get_wallet_nft_collections_oapg(
