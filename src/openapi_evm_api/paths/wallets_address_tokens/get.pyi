...
request_query_exclude_unverified_contracts = api_client.QueryParameter(
...
request_query_exclude_native = api_client.QueryParameter(
    name="exclude_native",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = Erc20TokenBalanceWithPriceResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wallet_token_balances_price_oapg(
        self,
...
class GetWalletTokenBalancesPrice(BaseApi):
    ...
    def get_wallet_token_balances_price(
        ...
        return self._get_wallet_token_balances_price_oapg(
