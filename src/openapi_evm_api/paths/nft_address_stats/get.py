...
SchemaFor200ResponseBodyApplicationJson = NftCollectionStat
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_nft_collection_stats_oapg(
        self,
...
class GetNftCollectionStats(BaseApi):
    ...
    def get_nft_collection_stats(
        ...
        return self._get_nft_collection_stats_oapg(
