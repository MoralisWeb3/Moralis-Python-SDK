...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'owner_address': typing.Union[OwnerAddressSchema, str, ],
        'spender_address': typing.Union[SpenderAddressSchema, str, ],
    }
)
...
request_query_owner_address = api_client.QueryParameter(
    name="owner_address",
    style=api_client.ParameterStyle.FORM,
    schema=OwnerAddressSchema,
    required=True,
    explode=True,
)
request_query_spender_address = api_client.QueryParameter(
    name="spender_address",
    style=api_client.ParameterStyle.FORM,
    schema=SpenderAddressSchema,
    required=True,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = Erc20Allowance
...
class GetTokenAllowance(BaseApi):
    ...
    def get_token_allowance(
        ...
        return self._get_token_allowance_oapg(
