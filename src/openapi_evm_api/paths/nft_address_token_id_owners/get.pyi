...
SchemaFor200ResponseBodyApplicationJson = NftOwnerCollection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_nft_token_id_owners_oapg(
        self,
...
class GetNftTokenIdOwners(BaseApi):
    ...
    def get_nft_token_id_owners(
        ...
        return self._get_nft_token_id_owners_oapg(
