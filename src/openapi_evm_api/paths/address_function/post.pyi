...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'function_name': typing.Union[FunctionNameSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = RunContractDto


request_body_run_contract_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _run_contract_function_oapg(
        self,
    ...
    def _run_contract_function_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_run_contract_dto.serialize(body, content_type)
...
class RunContractFunction(BaseApi):
    ...
    def run_contract_function(
        ...
        return self._run_contract_function_oapg(
            body=body,
