...
class FilterSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            ...
            "name,description,attributes": "NAMEDESCRIPTIONATTRIBUTES",
        }
    ...
    @schemas.classproperty
    def NAMEDESCRIPTION(cls):
        return cls("name,description")
    
    @schemas.classproperty
    def NAMEATTRIBUTES(cls):
        return cls("name,attributes")
    
    @schemas.classproperty
    def DESCRIPTIONATTRIBUTES(cls):
        return cls("description,attributes")
    
    @schemas.classproperty
    def NAMEDESCRIPTIONATTRIBUTES(cls):
        return cls("name,description,attributes")
