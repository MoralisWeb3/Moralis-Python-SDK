...
request_query_token_address = api_client.QueryParameter(
    name="token_address",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = DiscoveryToken
...
class GetDiscoveryToken(BaseApi):
    ...
    def get_discovery_token(
        ...
        return self._get_discovery_token_oapg(
