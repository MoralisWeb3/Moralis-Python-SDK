...
SchemaFor200ResponseBodyApplicationJson = Erc20TransactionCollection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wallet_token_transfers_oapg(
        self,
...
class GetWalletTokenTransfers(BaseApi):
    ...
    def get_wallet_token_transfers(
        ...
        return self._get_wallet_token_transfers_oapg(
