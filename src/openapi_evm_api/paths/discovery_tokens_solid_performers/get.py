...
OneDayNetVolumeChangeUsdSchema = schemas.NumberSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'one_day_net_volume_change_usd': typing.Union[OneDayNetVolumeChangeUsdSchema, decimal.Decimal, int, float, ],
...
request_query_one_day_net_volume_change_usd = api_client.QueryParameter(
    name="one_day_net_volume_change_usd",
    style=api_client.ParameterStyle.FORM,
    schema=OneDayNetVolumeChangeUsdSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_solid_performers_tokens_oapg(
        self,
    ...
    def _get_solid_performers_tokens_oapg(
        ...
        for parameter in (
            ...
            request_query_one_day_net_volume_change_usd,
...
class GetSolidPerformersTokens(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_solid_performers_tokens(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_solid_performers_tokens(
        ...
        return self._get_solid_performers_tokens_oapg(
