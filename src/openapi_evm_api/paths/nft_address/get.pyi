...
request_query_normalize_metadata = api_client.QueryParameter(
...
SchemaFor200ResponseBodyApplicationJson = NftCollection
...
class GetContractNfts(BaseApi):
    ...
    def get_contract_nfts(
        ...
        return self._get_contract_nfts_oapg(
