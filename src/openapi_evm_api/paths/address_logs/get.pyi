...
request_query_topic0 = api_client.QueryParameter(
    name="topic0",
    style=api_client.ParameterStyle.FORM,
    schema=Topic0Schema,
    required=True,
...
SchemaFor200ResponseBodyApplicationJson = LogCollection
...
class GetContractLogs(BaseApi):
    ...
    def get_contract_logs(
        ...
        return self._get_contract_logs_oapg(
