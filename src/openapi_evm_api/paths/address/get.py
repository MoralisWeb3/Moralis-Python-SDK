...
SchemaFor200ResponseBodyApplicationJson = TransactionCollection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_wallet_transactions_oapg(
        self,
...
class GetWalletTransactions(BaseApi):
    ...
    def get_wallet_transactions(
        ...
        return self._get_wallet_transactions_oapg(
