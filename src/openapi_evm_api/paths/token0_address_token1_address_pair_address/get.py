...
class ExchangeSchema(
    ...
    def UNISWAPV2(cls):
        return cls("uniswapv2")
    
    @schemas.classproperty
    def UNISWAPV3(cls):
        return cls("uniswapv3")
    
    @schemas.classproperty
    def SUSHISWAPV2(cls):
        return cls("sushiswapv2")
    
    @schemas.classproperty
    def PANCAKESWAPV2(cls):
        return cls("pancakeswapv2")
    
    @schemas.classproperty
    def PANCAKESWAPV1(cls):
        return cls("pancakeswapv1")
    
    @schemas.classproperty
    def QUICKSWAP(cls):
        return cls("quickswap")
...
SchemaFor200ResponseBodyApplicationJson = ReservesCollection
...
class GetPairAddress(BaseApi):
    ...
    def get_pair_address(
        ...
        return self._get_pair_address_oapg(
