...
FromBlockSchema = schemas.IntSchema
ToBlockSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'exclude_contracts': typing.Union[ExcludeContractsSchema, list, tuple, ],
        'wallet_addresses': typing.Union[WalletAddressesSchema, list, tuple, ],
        'exclude_wallets': typing.Union[ExcludeWalletsSchema, list, tuple, ],
...
request_query_exclude_contracts = api_client.QueryParameter(
    name="exclude_contracts",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeContractsSchema,
    explode=True,
)
...
request_query_exclude_wallets = api_client.QueryParameter(
    name="exclude_wallets",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludeWalletsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = Erc20TransfersResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_erc20_transfers_oapg(
        ...
        for parameter in (
            ...
            request_query_exclude_contracts,
            request_query_wallet_addresses,
            request_query_exclude_wallets,
...
class GetErc20Transfers(BaseApi):
    ...
    def get_erc20_transfers(
        ...
        return self._get_erc20_transfers_oapg(
