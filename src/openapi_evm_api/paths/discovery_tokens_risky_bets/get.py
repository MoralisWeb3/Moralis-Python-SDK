...
MaxMarketCapSchema = schemas.NumberSchema
OneWeekHoldersChangeSchema = schemas.NumberSchema
OneWeekNetVolumeChangeUsdSchema = schemas.NumberSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'max_market_cap': typing.Union[MaxMarketCapSchema, decimal.Decimal, int, float, ],
        'one_week_holders_change': typing.Union[OneWeekHoldersChangeSchema, decimal.Decimal, int, float, ],
        'one_week_net_volume_change_usd': typing.Union[OneWeekNetVolumeChangeUsdSchema, decimal.Decimal, int, float, ],
...
request_query_max_market_cap = api_client.QueryParameter(
    name="max_market_cap",
    style=api_client.ParameterStyle.FORM,
    schema=MaxMarketCapSchema,
    explode=True,
)
request_query_one_week_holders_change = api_client.QueryParameter(
    name="one_week_holders_change",
    style=api_client.ParameterStyle.FORM,
    schema=OneWeekHoldersChangeSchema,
    explode=True,
)
request_query_one_week_net_volume_change_usd = api_client.QueryParameter(
    name="one_week_net_volume_change_usd",
    style=api_client.ParameterStyle.FORM,
    schema=OneWeekNetVolumeChangeUsdSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_risky_bets_tokens_oapg(
        self,
    ...
    def _get_risky_bets_tokens_oapg(
        ...
        for parameter in (
            request_query_chain,
            request_query_max_market_cap,
            request_query_one_week_holders_change,
            request_query_one_week_net_volume_change_usd,
...
class GetRiskyBetsTokens(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_risky_bets_tokens(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_risky_bets_tokens(
        ...
        return self._get_risky_bets_tokens_oapg(
