...
class NftOwnerCollection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "total", "page", "page_size", "cursor", "result", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "total", "page", "page_size", "cursor", "result", ], str]):
