...
class TransactionCollectionVerbose(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["result", "cursor", "page", "page_size", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["result", "cursor", "page", "page_size", ], str]):
