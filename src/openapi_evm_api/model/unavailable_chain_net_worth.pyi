...
class UnavailableChainNetWorth(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["chain_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["chain_id", ], str]):
