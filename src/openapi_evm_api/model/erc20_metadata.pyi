...
class Erc20Metadata(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "name", "symbol", "decimals", "possible_spam", "logo", "logo_hash", "thumbnail", "block_number", "validated", "verified_collection", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "name", "symbol", "decimals", "possible_spam", "logo", "logo_hash", "thumbnail", "block_number", "validated", "verified_collection", ], str]):
