...
class Erc20Mint(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token_name", "token_symbol", "token_decimals", "contract_address", "transaction_hash", "transaction_index", "log_index", "block_timestamp", "block_number", "block_hash", "to_wallet", "value", "value_decimal", "token_logo", "possible_spam", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token_name", "token_symbol", "token_decimals", "contract_address", "transaction_hash", "transaction_index", "log_index", "block_timestamp", "block_number", "block_hash", "to_wallet", "value", "value_decimal", "token_logo", "possible_spam", ], str]):
