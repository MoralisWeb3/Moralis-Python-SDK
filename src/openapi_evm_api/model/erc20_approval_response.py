        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Erc20Approval']:
                        return Erc20Approval
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Erc20Approval'], typing.List['Erc20Approval']],
                ...
                def __getitem__(self, i: int) -> 'Erc20Approval':
