...
class Erc20TokenBalanceWithPriceResult(
        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Erc20TokenBalanceWithPrice']:
                        return Erc20TokenBalanceWithPrice
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Erc20TokenBalanceWithPrice'], typing.List['Erc20TokenBalanceWithPrice']],
                ...
                def __getitem__(self, i: int) -> 'Erc20TokenBalanceWithPrice':
