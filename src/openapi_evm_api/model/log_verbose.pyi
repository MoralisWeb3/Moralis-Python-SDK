...
class LogVerbose(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            decoded_event = schemas.DictSchema
    ...
    decoded_event: MetaOapg.properties.decoded_event
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["decoded_event"]) -> MetaOapg.properties.decoded_event: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["log_index", "transaction_hash", "transaction_index", "address", "data", "topic0", "block_timestamp", "block_number", "block_hash", "decoded_event", "topic1", "topic2", "topic3", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["decoded_event"]) -> MetaOapg.properties.decoded_event: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["log_index", "transaction_hash", "transaction_index", "address", "data", "topic0", "block_timestamp", "block_number", "block_hash", "decoded_event", "topic1", "topic2", "topic3", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        decoded_event: typing.Union[MetaOapg.properties.decoded_event, dict, frozendict.frozendict, ],
        ...
        topic1: typing.Union[MetaOapg.properties.topic1, str, schemas.Unset] = schemas.unset,
        topic2: typing.Union[MetaOapg.properties.topic2, str, schemas.Unset] = schemas.unset,
        topic3: typing.Union[MetaOapg.properties.topic3, str, schemas.Unset] = schemas.unset,
