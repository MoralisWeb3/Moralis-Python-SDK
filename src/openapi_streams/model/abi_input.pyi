...
class AbiInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["type"], typing_extensions.Literal["indexed"], typing_extensions.Literal["components"], typing_extensions.Literal["internalType"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["type"], typing_extensions.Literal["indexed"], typing_extensions.Literal["components"], typing_extensions.Literal["internalType"], ]):
