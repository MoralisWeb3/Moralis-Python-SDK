...
# Path params
StreamIdSchema = StreamTypesUUID
IdSchema = HistoryTypesUUID
...
SchemaFor200ResponseBodyApplicationJson = HistoryTypesHistoryModel
...
class ReplayHistory(BaseApi):
    ...
    def replay_history(
        ...
        return self._replay_history_oapg(
