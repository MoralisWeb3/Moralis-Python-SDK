...
ExcludePayloadSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'excludePayload': typing.Union[ExcludePayloadSchema, bool, ],
    },
    total=False
)
...
request_query_exclude_payload = api_client.QueryParameter(
    name="excludePayload",
    style=api_client.ParameterStyle.FORM,
    schema=ExcludePayloadSchema,
    explode=True,
)
_auth = [
    'x-api-key',
]
SchemaFor200ResponseBodyApplicationJson = HistoryTypesHistoryResponse
