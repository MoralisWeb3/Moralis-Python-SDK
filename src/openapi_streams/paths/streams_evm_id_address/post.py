...
# body param
SchemaForRequestBodyApplicationJson = AddressesTypesAddressesAdd


request_body_addresses_types_addresses_add = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_address_to_stream_oapg(
        self,
    ...
    def _add_address_to_stream_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_addresses_types_addresses_add.serialize(body, content_type)
...
class AddAddressToStream(BaseApi):
    ...
    def add_address_to_stream(
        ...
        return self._add_address_to_stream_oapg(
            body=body,
