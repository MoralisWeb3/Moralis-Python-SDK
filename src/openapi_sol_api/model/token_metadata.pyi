...
class TokenMetadata(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metaplex() -> typing.Type['MetaplexToken']:
                return MetaplexToken
            __annotations__ = {
                "mint": mint,
                "standard": standard,
                "name": name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metaplex"]) -> 'MetaplexToken': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metaplex"]) -> 'MetaplexToken': ...
