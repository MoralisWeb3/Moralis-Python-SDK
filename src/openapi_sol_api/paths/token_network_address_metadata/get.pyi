...
from openapi_sol_api import api_client, exceptions
...
SchemaFor200ResponseBodyApplicationJson = TokenMetadata
...
class GetTokenMetadata(BaseApi):
    ...
    def get_token_metadata(
        ...
        return self._get_token_metadata_oapg(
